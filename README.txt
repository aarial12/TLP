...
Eventos disponibles: ON START, ON TICK, ON EAT_FOOD, ON EAT_POWERUP, ON COLLISION_WALL, ON COLLISION_SELF, ON KEY_UP, ON KEY_DOWN, ON KEY_LEFT, ON KEY_RIGHT
